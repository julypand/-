...
public class RequestTaskDeleteClass extends AsyncTask<String, Void, Void> {
    ...
    public RequestTaskDeleteClass(Activity activity,Context context,int idClass){
