...
INSERT INTO `class` VALUES (1,'ПиРВ'),(2,'СУБД'),(3,'ЭСУПК'),(4,'ИИС'),(5,'с/к'),(6,'с/л'),(7,'ИСМ'),(8,'Экология'),(20,'gfhhvjvjc');
...
CREATE TABLE `user` (
  ...
  `isPrefect` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `user` VALUES (1,'Natalie','Pakki','fecit@inbox.ru','wXwgAWh6YVeq8d8reFtWFQ==\n',15,1),(2,'Yulian','Haponenka','yulian@gmail.com','VKKc8nHi+6ZfpSvo5p9ucw==\n',13,0),(4,'Dima','Kachkov','kach@gmail.com','VKKc8nHi+6ZfpSvo5p9ucw==\n',13,0),(7,'Anna','Tanana','gave@gmail.com','wXwgAWh6YVeq8d8reFtWFQ==\n',15,0),(9,'Julia','Vykhota','julypand@gmail.com','Yy+g0h5NG3Bmo+ULj0KpMg==\n',15,0);
...
INSERT INTO `user_has_schedule` VALUES (1,13),(4,13),(1,15),(7,15),(9,15),(9,23);
...
-- Dump completed on 2016-05-12  0:28:23
